...
st.sidebar.title("🎓 Student Placement System")
...
if page == "🏠 Home":
    ...
    st.title("🎓 Student Placement Prediction & Career Guidance System")

    st.write("""
    This application uses Machine Learning to predict whether
    a student is likely to get placed based on academic performance,
    technical skills and other important factors.
    """)
    ...
    with col2:
        st.info("📊 Student Analysis")
        st.write("Academic and Skill Analysis")

    with col3:
        st.info("🔮 Placement Prediction")
        st.write("Predict Placement Status")
...
# ---------------- PREDICTION PAGE ---------------- #
    ...
    if st.button("🔮 Predict Placement", use_container_width=True):
        ...
        if prediction[0] == 1:
            ...
            st.success(
                "🎉 Congratulations! The student is likely to be PLACED."
            )
